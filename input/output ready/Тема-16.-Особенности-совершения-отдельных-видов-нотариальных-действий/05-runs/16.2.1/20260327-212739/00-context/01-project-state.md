...
- Следующая конечная подтема уже поднята: `16.2.1. Свидетельствование подлинности подписи на документах.`
...
- По run `16.2.1` уже готовы:
  - `02-stage-outputs\part-01.md`
...
- Следующее действие: собрать Part 2 для `16.2.1` уже без ручного relay пользователя и затем разворачивать follow-up части по тому же автономному контуру.
