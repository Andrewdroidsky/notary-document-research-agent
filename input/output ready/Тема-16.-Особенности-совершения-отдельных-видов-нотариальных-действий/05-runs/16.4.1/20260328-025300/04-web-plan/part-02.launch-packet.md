# Part 02 Launch Packet: 16.4.1. Виды фактов, удостоверяемых нотариусом.
...
- Первая строка: `ТЕМА: 16.4.1. Виды фактов, удостоверяемых нотариусом.`
...
- Не смешивать самостоятельный тарифный разбор с базовой подтемой: тариф вынесен в `16.4.3`.
- Тарифный блок должен быть привязан к базовому действию из `16.4.2`.
