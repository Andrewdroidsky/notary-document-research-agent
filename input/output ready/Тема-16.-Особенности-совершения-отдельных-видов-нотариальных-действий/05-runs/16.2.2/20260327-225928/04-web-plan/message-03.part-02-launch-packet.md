# Part 02 Launch Packet: 16.2.2. Исчисление размера федерального и регионального тарифа при свидетельствовании подлинности подписи.
...
- Первая строка: `ТЕМА: 16.2.2. Исчисление размера федерального и регионального тарифа при свидетельствовании подлинности подписи.`
...
- Тарифный блок должен быть привязан к базовому действию из `16.2.1`.
